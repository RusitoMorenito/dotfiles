...
shutdown_bt = PhotoImage(file = "~/.config/i3status/logout/shutdown.png")
restart_bt = PhotoImage(file= "~/.config/i3status/logout/restart.png")
logout_bt = PhotoImage(file = "~/.config/i3status/logout/logout.png")
close_bt = PhotoImage(file = "~/.config/i3status/logout/close.png")
lock_bt = PhotoImage(file = "~/.config/i3status/logout/lock.png")
background = PhotoImage(file = "~/.config/i3status/logout/background.png")
