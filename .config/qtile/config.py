...
keys = [
 ...
 #   Key([mod], "f", lazy.window.toggle_fullscreen(),
    ...
    Key([mod], "a", lazy.hide_show_bar(), desc="Toggle visibility of Bar"),

    Key([mod], "f", lazy.window.toggle_fullscreen(), lazy.hide_show_bar(), desc="toggle fullscreen"),


    Key([], "XF86AudioPlay", lazy.spawn("playerctl play-pause")),

    #---    Lock screen ---#
    Key([mod], "z", lazy.spawn("betterlockscreen --lock"))
]
